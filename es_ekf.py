...
################################################################################################
gt = data['gt']             # [nx3]
imu_f = data['imu_f']       # [nx3]
imu_w = data['imu_w']       # [nx3]
gnss = data['gnss']         # [nx3]
lidar = data['lidar']       # [nx3]
...
def measurement_update(sensor_var, p_cov_check, y_k, p_check, v_check, q_check):
    ...
    q_hat = Quaternion(axis_angle=phi_delta).quat_mult_right(q_check) 
...
for k in range(1, imu_f.data.shape[0]):  # start at 1 b/c we have initial prediction from gt
    ...
    F[3:6, 6:9] = C_ns.dot(-skew_symmetric(imu_f.data[k-1].reshape((3,1)))) * delta_t
